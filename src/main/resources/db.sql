...
INSERT INTO property (address_line1, address_line2, address_line3, postcode, town, no_of_bathrooms,
                      ...
                      students_allowed, property_type, price_in_pence)
VALUES ('12 Bellington', '', '', 'SE10 1BW', 'Greenwich', 2, 2, 1, TRUE, TRUE, TRUE, TRUE, TRUE, 'FOR_SALE', 733425),
       ('9 Illison', '', '', 'SE10 4JW', 'Lewisham', 2, 2, 1, TRUE, TRUE, TRUE, TRUE, TRUE, 'FOR_SALE', 335212),
       ('98 Hedgeway', '', '', 'SE15 2JK', 'Isle of Dogs', 2, 2, 1, TRUE, TRUE, TRUE, TRUE, TRUE, 'FOR_SALE', 515232),
       ('20 River Road', '', '', 'SE11 5MN', 'Thamesmead', 3, 4, 2, TRUE, TRUE, TRUE, TRUE, TRUE, 'FOR_SALE', 650000),
       ('35 Oak Lane', '', '', 'SE12 6AB', 'Peckham', 1, 3, 2, FALSE, FALSE, TRUE, FALSE, FALSE, 'FOR_SALE', 290000),
       ('48 Pine Court', '', '', 'SE13 7QP', 'Blackheath', 2, 3, 1, TRUE, TRUE, TRUE, TRUE, TRUE, 'FOR_SALE', 410000);
