...
VALUES ('12 Bellington', '', '', 'SE10 1BW', 'Greenwich', 2, 2, 1, TRUE, TRUE, TRUE, TRUE, TRUE,
        'FOR_SALE', 733425, 51.4826, -0.0077),
       ('9 Illison', '', '', 'SE10 4JW', 'Lewisham', 2, 2, 1, TRUE, TRUE, TRUE, TRUE, TRUE,
        'FOR_SALE', 335212, 51.4597, -0.0188),
       ('98 Hedgeway', '', '', 'SE15 2JK', 'Isle of Dogs', 2, 2, 1, TRUE, TRUE, TRUE, TRUE, TRUE,
        'FOR_SALE', 515232, 51.5095, -0.0243),
       ('20 River Road', '', '', 'SE11 5MN', 'Thamesmead', 3, 4, 2, TRUE, TRUE, TRUE, TRUE, TRUE,
        'FOR_SALE', 650000, 51.4911, 0.0728),
       ('35 Oak Lane', '', '', 'SE12 6AB', 'Peckham', 1, 3, 2, FALSE, FALSE, TRUE, FALSE, FALSE,
        'FOR_SALE', 290000, 51.4743, -0.0560),
       ('48 Pine Court', '', '', 'SE13 7QP', 'Blackheath', 2, 3, 1, TRUE, TRUE, TRUE, TRUE, TRUE,
